...
// multiple items can be combined to larger list.
// 
...
// of the found item or the end of the "unique" list reached and it is appended
// as new "unique" list item.
//
// Each added Channel object now part of a "same" list which can be directly
...
//
// Channel objects itself contain a context pointer, a callback function and
